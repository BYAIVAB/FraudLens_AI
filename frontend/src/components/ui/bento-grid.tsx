...
function BentoGrid({ items = itemsSample }: BentoGridProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-4 max-w-7xl mx-auto">
            {items.map((item, index) => (
                <div
                    key={index}
                    className={cn(
                        "group relative p-4 rounded-xl overflow-hidden transition-all duration-300",
                        "border border-gray-100/80 dark:border-white/10 bg-white",
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="space-y-2">
                            <div className="font-medium text-gray-900 dark:text-gray-900">
                                ...
                                <span className="ml-2 text-sm text-gray-600 dark:text-gray-600 font-normal">
                                    {item.meta}
                                </span>
                            </div>
                            <p className="text-lg text-gray-800 dark:text-gray-800 leading-snug">
                                {item.description}
                            </p>
                        </div>
