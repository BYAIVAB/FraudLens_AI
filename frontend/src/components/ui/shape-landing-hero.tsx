...
function HeroGeometric({
    ...
    const title2Words = title2 ? title2.split(' ') : [];
    const gradient1Text = title2Words.slice(0, 2).join(' ');
    const gradient2Text = title2Words.slice(2).join(' ');
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-8 md:mb-12 mt-12"
                    >
                    ...
                    {description && (
                        <motion.div
                            ...
                            animate="visible"
                        >
                            <p className="text-base sm:text-lg md:text-xl text-white/60 mb-10 leading-relaxed font-medium tracking-wide max-w-2xl mx-auto px-4">
                                {description}
                            </p>
                        </motion.div>
                    )}
                    ...
                    {ctaText && (
                         <motion.div
                            ...
                            animate="visible"
                        >
                            <button className="bg-white/10 text-white font-semibold py-3 px-8 rounded-full border border-white/20 shadow-lg hover:shadow-xl hover:bg-white/20 transition-all duration-300">
                                {ctaText}
                            </button>
                        </motion.div>
                    )}
